...
class ParticleGenerator
{
	...
	public:
		ParticleGenerator() {};
		ParticleGenerator(std::string name, Object* model, double _genprob, int maxpart) : _name(name), _model(model), _generator_probability(_genprob), _num_particles(maxpart) {};
		~ParticleGenerator() {};
